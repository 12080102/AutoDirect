		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"><i class="fa fa-wrench fa-fw"></i> Product
							Management<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="admin/product">Product</a></li>
							<li><a href="admin/productline">ProductLine</a></li>
						</ul> <!-- /.nav-second-level --></li>
						<li><a href="admin/order"><i class="fa fa-files-o fa-fw"></i>
					...
					<li><a href="#"><i class="fa fa-wrench fa-fw"></i> Product
							Management<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="panels-wells.html">Product</a></li>
							<li><a href="buttons.html">ProductLine</a></li>

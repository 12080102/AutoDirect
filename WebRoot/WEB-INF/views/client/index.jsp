	...
	<div id="sidebar" class="span3">
		<div class="well well-small"><a id="myCart" href="product_summary.html"><img src="themes/images/ico-cart.png" alt="cart">3 Items in your cart  <span class="badge badge-warning pull-right">$155.00</span></a></div>
					<ul id="sideManu" class="nav nav-tabs nav-stacked">
						...
						<li class="subMenu open"><a> CARS [230]</a>
							<ul>
								<li><a class="active"
									href="type/classiccars?name=${user.name}"><i
										class="icon-chevron-right"></i>Classic Cars (100) </a></li>
								<li><a href="type/vintagecars?name=${user.name}"><i
										class="icon-chevron-right"></i> Vintage Cars (30)</a></li>
							</ul></li>

						<li><a href="type/motorcycles?name=${user.name}">MOTORCYCLES
								[18]</a></li>

						<li class="subMenu"><a> WATER VEHICALS [1000]</a>
							<ul style="display:none">
								<li><a href="type/ships?name=${user.name}"><i
										class="icon-chevron-right"></i>Ships (35)</a></li>
								<li><a href="type/boats?name=${user.name}"><i
										class="icon-chevron-right"></i> Boats (8)</a></li>
							</ul></li>
						<li><a href="type/trains?name=${user.name}">TRAINS [18]</a></li>
						<li><a href="type/truckbus?name=${user.name}">TRUCKS ANS
								BUSSES [58]</a></li>
						<li><a href="type/plains?name=${user.name}">PLAINS [14]</a></li>
					</ul>
					<br />

			...
			<div id="welcomeLine" class="row">
				...
				<div class="span6">
					<div class="pull-right">
						...
						<span class="btn btn-mini">$${cartprice }</span> <a
							href="product_summary.html"><span class="">$</span></a> <a
							href="shopping/checkcart?user=${user.name }"><span
							class="btn btn-mini btn-primary"><i
								class="icon-shopping-cart icon-white"></i> [ ${cartitem } ]
		...
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				<div class="item active">
					<div class="container">
						<a href=""><img style="width:100%"
							src="themes/images/carousel/8.png" alt="special offers" /></a>
				...
				<div class="item">
					<div class="container">
						<a href=""><img style="width:100%"
							src="themes/images/carousel/9.png" alt="" /></a>
						<div class="carousel-caption">
							<h4>Second Thumbnail label</h4>
							<p>Cras justo odio, dapibus ac facilisis in, egestas eget
								quam. Donec id elit non mi porta gravida at eget metus. Nullam

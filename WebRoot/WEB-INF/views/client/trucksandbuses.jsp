...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    <a class="brand" href="helloworld?name=${user.name}"><img src="themes/images/logo.png" alt="Bootsshop"/></a>
...
<!-- Sidebar end=============================================== -->
	<div class="span9">
					<ul class="breadcrumb">
						...
						<li class="active">Trucks and Buses</li>
					</ul>
					<h3>
						Trucks and Buses <small class="pull-right"> ${pc.truckandbus} products are
							available </small>
					</h3>
					<hr class="soft" />

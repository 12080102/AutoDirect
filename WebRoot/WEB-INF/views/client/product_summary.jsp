		...
		<div class="container">
			<div id="welcomeLine" class="row">
				...
				<div class="span6">
					<div class="pull-right">
						<a href="shopping/checkcart?user=${user}"><span
			...
			<div id="logoArea" class="navbar">
				...
				<div class="navbar-inner">
					<a class="brand" href="helloworld2?name=${user}"><img
			...
			<div class="row">
				...
				<div id="sidebar" class="span3">
					<div class="well well-small">
						<a id="myCart" href="shopping/checkcart?user=${user}"><img
							src="themes/images/ico-cart.png" alt="cart">${cartitem}
							Items in your cart <span class="badge badge-warning pull-right">$${cartprice
								}</span></a>
					</div>
					<ul id="sideManu" class="nav nav-tabs nav-stacked">
						...
						<li class="subMenu"><a> CARS [${pc.cars }]</a>
							<ul style="display:none">
								<li><a class="active" href="type/classiccars?name=${user}"><i
										class="icon-chevron-right"></i>Classic Cars
										(${pc.classicCars}) </a></li>
								<li><a href="type/vintagecars?name=${user}"><i
										class="icon-chevron-right"></i> Vintage Cars
										(${pc.vintageCars})</a></li>
							</ul></li>

						<li><a href="type/motorcycles?name=${user}">MOTORCYCLES
								(${pc.motorcycles})</a></li>

						<li class="subMenu"><a> WATER VEHICALS [${pc.waters}]</a>
							<ul style="display:none">
								<li><a href="type/ships?name=${user}"><i
										class="icon-chevron-right"></i>Ships (${pc.ships})</a></li>
								<li><a href="type/boats?name=${user}"><i
										class="icon-chevron-right"></i> Boats (${pc.boats})</a></li>
							</ul></li>
						<li><a href="type/trains?name=${user}">TRAINS
								[${pc.trains}]</a></li>
						<li><a href="type/truckbus?name=${user}">TRUCKS ANS
								BUSSES [${pc.truckandbus}]</a></li>
						<li><a href="type/plains?name=${user}">PLAINS
								[${pc.plains}]</a></li>
					</ul>
					<br />
					<div class="thumbnail">
				...
				<div class="span9">
					...
					<h3>
						SHOPPING CART [ <small>${cartitem} Item(s) </small>]<a
					...
					<table class="table table-bordered">
						...
						<tbody>
							<c:forEach var="list" items="${lp}">
								<tr>
									<td><img width="60" src="${list.picurl}" alt="" /></td>
									<td>${list.productName}<br />
									</td>
									<td>
										<div class="input-append">
											<input class="span1" style="max-width:34px"
												placeholder="${list.quantity }" id="appendedInputButtons"
												size="16" type="text">
											...
											<a
												href="shopping/cartdelete?user=${user}&code=${list.cartCode}"><button
					...
					<table class="table table-bordered">
						...
						<tr>
							<td>
								<form class="form-horizontal" action="shopping/checkout">
									<div class="control-group">
										<label class="control-label" for="inputCountry">Required Deliver Date
										</label>
										<div class="controls">
											<input type="text" id="inputCountry" name="deliverdate"
												required autofocus placeholder="2017-05-12">
					...
					<%-- <a href="products.html" class="btn btn-large"><i
						...
						href="/shopping/checkout?user=${user}&deliverdate=#{inputCountry} "
